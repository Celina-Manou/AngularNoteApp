...
import { SettingsModule } from 'src/app/pomodoro/settings/settings.module';
import { TimerComponent } from 'src/app/pomodoro/timer/timer.component';
import { StatusBarComponent } from 'src/app/pomodoro/status-bar/status-bar.component';
